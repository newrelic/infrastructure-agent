...
func PdhAddEnglishCounter(hQuery PDH_HQUERY, szFullCounterPath string, dwUserData uintptr, phCounter *PDH_HCOUNTER) uint32 {
	if pdh_AddEnglishCounterW == nil {
		return PdhAddCounter(hQuery, szFullCounterPath, dwUserData, phCounter)
	}
...
// counter that contains a wildcard character for the instance name. The itemBuffer must be slice of type PDH_FMT_COUNTERVALUE_ITEM_DOUBLE.
...
// Returns an array of formatted counter values. Use this function when you want to format the counter values of a
// counter that contains a wildcard character for the instance name. The itemBuffer must be slice of type PDH_FMT_COUNTERVALUE_ITEM_LARGE.
...
// Returns an array of formatted counter values. Use this function when you want to format the counter values of a
// counter that contains a wildcard character for the instance name. The itemBuffer must be slice of type PDH_FMT_COUNTERVALUE_ITEM_LONG.
// For an example usage, see PdhGetFormattedCounterArrayDouble.
//
