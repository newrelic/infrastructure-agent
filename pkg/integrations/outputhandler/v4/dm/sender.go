...
import (
	"github.com/newrelic/infrastructure-agent/pkg/integrations/outputhandler/v4/dm/cumulative"
	"github.com/newrelic/infrastructure-agent/pkg/integrations/outputhandler/v4/dm/rate"
