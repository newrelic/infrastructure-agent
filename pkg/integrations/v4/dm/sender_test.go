...
func Test_sender_SendMetrics(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.fields.harvester.On("RecordMetrics", expectedAttributes, tt.expectedMetrics).Return(nil)
...
func Test_sender_SenderMetric_cumulative_CountCalculator(t *testing.T) {
	...
	harvester.On("RecordMetrics", mock.AnythingOfType("telemetryapi.Attributes"), expectedMetrics).Return(nil)
	err := s.SendMetricsWithCommonAttributes(protocol.Common{
		Timestamp: &cannedDateUnix,
		Interval:  &cannedDurationInt,
		Attributes: map[string]interface{}{
...
func Test_sender_SendMetric_cumulative_count_invalid_metric(t *testing.T) {
	...
	harvester.AssertNotCalled(t, "RecordMetrics", mock.AnythingOfType("telemetryapi.Attributes"), mock.AnythingOfType("[]telemetry.Metric"))
...
func Test_sender_SendMetric_rate_cumulative_invalid_metric_value(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			harvester.On("RecordMetrics", mock.AnythingOfType("telemetryapi.Attributes"), metrics).Return(nil)
			err := s.SendMetricsWithCommonAttributes(protocol.Common{
				Timestamp: &cannedDateUnix,
				Interval:  &cannedDurationInt,
				Attributes: map[string]interface{}{
...
func TestSender_SendMetrics_invalid_metric_type(t *testing.T) {
	...
	require.NoError(t, err)
	harvester.AssertNotCalled(t, "RecordMetrics", mock.AnythingOfType("telemetryapi.Attributes"), mock.AnythingOfType("[]telemetry.Metrics"))
...
func (m *mockHarvester) RecordMetrics(commonAttributes telemetry.Attributes, metrics []telemetry.Metric) error {
