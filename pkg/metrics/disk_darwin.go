...
func getUtilizationDataFromIoCountersDelta(elapsedMs int64, ioCountersStats, lastDiskStats map[string]storage.IOCountersStat) (cd ioCountersData) {
	...
	for diskName := range ioCountersStats {
		...
		totalReads += darwinCounterLastStat.ReadCount - darwinCounterStat.ReadCount
		totalWrites += darwinCounterLastStat.WriteCount - darwinCounterStat.WriteCount
		totalIOTime += darwinCounterLastStat.IoTime - darwinCounterStat.IoTime
		totalReadTime += darwinCounterLastStat.ReadTime - darwinCounterStat.ReadTime
		totalWriteTime += darwinCounterLastStat.WriteTime - darwinCounterStat.WriteTime
	}
