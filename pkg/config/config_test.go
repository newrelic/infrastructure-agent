...
func TestLoadLogConfig_Populate(t *testing.T) {
	...
	var configs = []struct {
		...
		{"Verbose disabled (info level) and custom log file", Config{DeprecatedConfig: DeprecatedConfig{Verbose: 0, LogFile: "agent.log"}}, LogConfig{Level: LogLevelInfo, File: "agent.log", ToStdout: boolPtr(false), Forward: boolPtr(false), ExcludeFilters: LogFilters{"traces": []interface{}{"supervisor", "feature"}}, SmartLevelEntryLimit: intPtr(0)}},
		{"Smart Verbose enabled with defined limit", Config{DeprecatedConfig: DeprecatedConfig{Verbose: 2, SmartVerboseModeEntryLimit: 200}}, LogConfig{Level: LogLevelSmart, File: "", ToStdout: boolPtr(false), Forward: boolPtr(false), ExcludeFilters: LogFilters{"traces": []interface{}{"supervisor", "feature"}}, SmartLevelEntryLimit: intPtr(200)}},
		{"Forward Verbose enabled and stdout", Config{DeprecatedConfig: DeprecatedConfig{Verbose: 3, LogToStdout: true}}, LogConfig{Level: LogLevelDebug, File: "", ToStdout: boolPtr(true), Forward: boolPtr(true), ExcludeFilters: LogFilters{"traces": []interface{}{"supervisor", "feature"}}, SmartLevelEntryLimit: intPtr(0)}},
		{"Trace Verbose enabled and file", Config{DeprecatedConfig: DeprecatedConfig{Verbose: 4, LogFile: "agent.log"}}, LogConfig{Level: LogLevelTrace, File: "agent.log", ToStdout: boolPtr(false), Forward: boolPtr(false), ExcludeFilters: LogFilters{"traces": []interface{}{"supervisor", "feature"}}, SmartLevelEntryLimit: intPtr(0)}},
	}
